...
">Myticket</a></h1>
    ...
    echo '<div class="insc">
      ...
      <li id="sign"><a href="Signup.php">SingUp</a></li>
    </div>';
                        }
                        ?>
                ...
                ?>
                                <div class="container">
                                    ...
                                    <div class="buttom">
                                        ...
                                        <div class="ajouter">
                                            <div class="container-ajouter"><a href="commande.php"></a>
    ...
    ?>
                ...
                <div class="boutonP">
                    <div class="bouton">
                        <div class="grand-bouton">
                            <h2 class="img-sport"><a href="Sportif.php">sportif</a></h2>
                        </div>
                        <div class="grand-bouton">
                            <h2 class="img-culture"><a href="Culturel.php">culturel</a></h2>
                        </div>
                    </div>
                </div>
        ...
        <div style="text-align: right;">
            <div class="titre2">
                <h3><a href='Sportif.php'>Voir plus</a></h3>
            </div>
        </div>
